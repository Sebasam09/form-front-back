...
<body>
<div class="container">
	<h1 class="page-header text-center">Inicie sesion o registrese</h1>
	<div class="row">
		    	...
		    	<div class="panel-body">
		        	<form method="POST" action="login.php">
		            	<fieldset>
							...
							<button type="submit" name="r_button" id="r_button" class="btn btn-lg btn-primary btn-block"><span class="glyphicon glyphicon-log-in"></span> Register</button>
		            	</fieldset>
		        	</form>
		    	</div>
		    </div>
